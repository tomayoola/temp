...
public class TravelTracker implements ScanListener { //Mock objects for Charge and Register can jUnit throwing exceptions
    ...
    private void totalJourneysFor(Customer customer) {
        ...
        for (Journey journey : journeys) {
            BigDecimal journeyPrice = OFF_PEAK_JOURNEY_PRICE; //refactor polymorphic?
            if (peak(journey)) {
